...
class ZipRecruiterBoard(JobBoardBase):
    ...
    def login(self):
        ...
        try:
            ...
            logger.error(f"Error during ZipRecruiter login: {e}")
            return False
    ...
    def search_jobs(self, keywords, location):
        ...
        try:
            ...
            search_url = f"https://www.ziprecruiter.com/jobs/search?q={keyword_str}&location={location_str}"
            ...
            logger.info(f"Searching ZipRecruiter with URL: {search_url}")
